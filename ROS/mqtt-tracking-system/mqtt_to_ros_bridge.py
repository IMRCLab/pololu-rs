...
Requires:
    - webcam: BRIO 4K
    - aruco markers 16 bit, 5cm^2 (see markers/ in the repo)
    - source ROS2 
...
class MqttToRosBridge(Node):
    def __init__(self, mqtt_cfg: dict, robot_map: dict):
        ...
        self._t_last_msg = None  # for timing
    ...
    def _on_message(self, client, userdata, msg):
        ...
        interval = f"  interval={1000*(t_recv-self._t_last_msg):.1f}ms" if self._t_last_msg else ""
        self._t_last_msg = t_recv
