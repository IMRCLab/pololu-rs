...
pub mod robot_constants {
    ...
    pub const ENCODER_CPR: f32 = -GEAR_RATIO * 12.0; // Negative: encoder counts opposite to motor direction on 3Pi
...
pub mod robot_constants {
    ...
    pub const GEAR_RATIO: f32 = 100.31;
    pub const ENCODER_CPR: f32 = -GEAR_RATIO * 12.0; // Negative: encoder counts opposite to motor direction on Zumo default
